...
//removed determineDx function as it was causing FSL and implemented a better optimized version of the changePizzaSizes function
...
//ref: Udacity > FEND > Advanced Interactive Websites > Styles and Layouts > Stop FSL
...
var latestKnownY=0;
var ticking=window.ticking=false;

function onScroll()
{
  // Store the most recent value of Y while scrolling
  latestKnownY=window.scrollY;
  requestTick();
}
function requestTick()
{
  //To avoid running requestAnimationFrame at all times since we only need it when scrolling
  if(!ticking)
  {
...
function updatePositions() {
  ...
  // var scrollTop = document.documentElement.scrollTop || document.body.scrollTop;
    //removed scrollTop and replaced it with window.scrollY
